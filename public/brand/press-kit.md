...
**Our Mission:**
To democratize professional billing by providing freelancers and small businesses with a completely free, fast, and privacy-respecting invoice generation tool.

**Our Vision:**
A world where independent professionals never have to pay a monthly subscription fee just to get paid for their hard work.
...
For media inquiries, interview requests, or partnership opportunities, please contact the editorial team:
**Email:** press@invoice-gen.net

## Approved Assets

We require that all media coverage uses the actual application interface rather than generic or AI-generated artwork. You can download high-resolution UI screenshots and banners from our [Assets Directory](/assets/brand/).

- **Hero Screenshot (Desktop):** `/assets/brand/hero-screenshot-desktop.webp`
- **Hero Screenshot (Mobile):** `/assets/brand/hero-screenshot-mobile.webp`
