...
import { EstimateDetailsSection } from './EstimateDetailsSection';
...
import type { EstimateData, SavedEstimate } from '../../types/estimate';
...
export function EstimateGenerator() {
  ...
  const handleEditHistoryRecord = (invoice: SavedEstimate) => {
    attemptAction(() => {
  ...
  const handleDuplicateHistoryRecord = (invoice: SavedEstimate) => {
    attemptAction(() => {
    ...
    <div className="invoice-generator">
      ...
      <div style={{ position: 'fixed', top: '-9999px', left: '-9999px', zIndex: -9999, opacity: 0, pointerEvents: 'none' }}>
        <div id="pdf-render-container">
          <EstimateA4Preview data={data as any} scale={1} />
        </div>
      </div>
