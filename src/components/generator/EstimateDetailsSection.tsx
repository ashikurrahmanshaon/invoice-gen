...
interface EstimateDetailsSectionProps {
  ...
  onChange: (updates: Partial<EstimateData['details']>) => void;
}

export const EstimateDetailsSection: React.FC<EstimateDetailsSectionProps> = React.memo(({ details, onChange }) => {
  return (
    <div style={{ marginTop: '32px', paddingTop: '32px', borderTop: '1px solid #F1F5F9' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
        ...
        <h3 style={{ fontSize: '16px', fontWeight: 600, color: '#334155', margin: 0 }}>Estimate Details</h3>
      </div>
