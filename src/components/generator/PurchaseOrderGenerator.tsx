...
import type { PurchaseOrderData, SavedPurchaseOrder } from '../../types/purchaseOrder';
...
export function PurchaseOrderGenerator() {
  ...
  //       details: {
  //         ...data.details,
  //         invoiceNumber: generatePONumber(data.details.invoiceNumber) // Generate fresh number to avoid collision
  //       }
  //     }, 
  //     'Saved', 
  //     null
  ...
  //       details: {
  //         ...data.details,
  //         invoiceNumber: generatePONumber(data.details.invoiceNumber)
  //       }
  //     };
  ...
  const handleEditHistoryRecord = (invoice: SavedPurchaseOrder) => {
    attemptAction(() => {
  ...
  const handleDuplicateHistoryRecord = (invoice: SavedPurchaseOrder) => {
    attemptAction(() => {
      ...
      const duplicatedData = {
        ...
        details: {
          ...details,
          poNumber: generatePONumber((details as any).poNumber || ''),
  ...
  return (
    <div className="invoice-generator">
      ...
      <main className="container" id="generator" style={{ minWidth: 0 }}>
        ...
        {activeView === 'editor' && (!data.buyer.name && !data.vendor.name && data.items.length === 0) && (
            ...
            {isMobileView ? (
              <div style={{ width: '100%', minWidth: 0 }}>
                <MobileWizard 
                  ...
                  data={{...data, business: data.buyer, client: data.vendor} as any}
                  ...
                  <div className="card" style={{ padding: '0' }}>
                    ...
                    <div style={{ padding: '24px 32px' }}>
                      <div className="flex-col">
                        {currentStage === 1 && (
                            <div id="section-1">
                              <BusinessSection data={{...data, business: data.buyer} as any} updateBusiness={updateBusiness} />
                              <PODetailsSection data={data} updateDetails={updateDetails} />
                            </div>
                        )}
      ...
      <div style={{ position: 'fixed', top: '-9999px', left: '-9999px', zIndex: -9999, opacity: 0, pointerEvents: 'none' }}>
        <div id="pdf-render-container">
          <InvoiceA4Preview data={data as any} scale={1} />
        </div>
      </div>
